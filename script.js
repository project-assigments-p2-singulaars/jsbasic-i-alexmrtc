...
console.log(`La variable postres es: ${typeof(postres)}\n La variable coder es ${typeof(coder)}`)
...
let checkNumbers = numberOne === numberTwo;
...
let checkDifferentNumbers = numberOne !== numberTwo;

console.log(checkDifferentNumbers);
...
let result2 = comparacion !== result//Realiza la operación de comparación que consideres con las dos variables del ejercicio anterior para que el resultado en consola sea true.
console.log(result2)
